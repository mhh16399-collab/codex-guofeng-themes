...
function Get-DreamSkinText {
  ...
  $catalog = @{
    'en-US' = @{
      ...
      ChangeBackground = 'Change background image'; BackgroundTitle = 'Choose a Codex Guofeng Themes background image'
      BackgroundUpdated = 'Background image updated.'; ImportZip = 'Import theme ZIP...'
      ImportTitle = 'Choose a Codex Guofeng Themes theme ZIP'; SaveCurrent = 'Save current theme'
      SavePrompt = 'Theme name:'; SaveTitle = 'Save Codex Guofeng Themes theme'; Saved = 'Saved: {0}'
      ...
      Gallery = 'Guofeng Theme Gallery'; OpenSite = 'Project Home'
      ...
      UpdateTitle = 'Codex Guofeng Themes Update'; UpdateAvailable = 'Codex Guofeng Themes {0} is available.'
      UpdateQuestion = 'Open the GitHub download page?'; UpToDate = 'Codex Guofeng Themes {0} is up to date.'
    ...
    'zh-CN' = @{
      ...
      ChangeBackground = '更换背景图'; BackgroundTitle = '选择 Codex 国风主题背景图'
      BackgroundUpdated = '背景图已更新。'; ImportZip = '导入主题 ZIP…'
      ImportTitle = '选择 Codex 国风主题 ZIP'; SaveCurrent = '保存当前主题'
      SavePrompt = '输入主题名称：'; SaveTitle = '保存 Codex 国风主题'; Saved = '已保存：{0}'
      SavedThemes = '已保存主题'; NoSavedThemes = '暂无已保存主题'; Applied = '已应用：{0}'
      OpenThemes = '打开主题文件夹'; OpenImages = '打开图片文件夹'; CheckUpdate = '检查更新…'
      Gallery = '国风主题馆'; OpenSite = '打开项目主页'
      ...
      UpdateTitle = 'Codex 国风主题更新'; UpdateAvailable = 'Codex 国风主题 {0} 已发布。'
      UpdateQuestion = '是否打开 GitHub 下载页面？'; UpToDate = 'Codex 国风主题 {0} 已是最新版本。'
      UpdateFailed = '无法检查更新。'
